...
const FEATURES = [
    {
        ...
        desc: "Visual hierarchy that guides the eye to your CTA — not just pretty pictures.",
    },
    {
        icon: Palette,
        title: "Brand-Consistent Design",
        desc: "Your colors, fonts, and voice applied consistently across every flyer variant.",
    },
    {
        icon: Layers,
        title: "Print & Digital Ready",
        desc: "CMYK print files + RGB social media variants delivered in one package.",
    },
    {
        icon: Image,
        title: "Realistic Mockups",
        desc: "See your flyer on paper, in hand, on a bulletin board — before you print.",
    },
    {
        icon: PenTool,
        title: "Custom Illustrations",
        desc: "Hand-drawn elements that make your flyer stand out from template mills.",
    },
    {
        icon: CheckCircle2,
        title: "Print Vendor Coordination",
        desc: "We talk to your printer — bleed, trim, safe zones, paper stock — handled.",
    },
];

const PROCESS_STEPS = [
    { num: "01", title: "Brief & Goals", desc: "What's the offer? Who's the audience? What action do you want?" },
    { num: "02", title: "Concept & Copy", desc: "Headlines, body copy, and visual direction — 2-3 distinct routes." },
    { num: "03", title: "Design & Refine", desc: "Your chosen concept polished with imagery, typography, and spacing." },
    { num: "04", title: "Delivery", desc: "Print PDFs, web PNGs, social cuts, mockups, and printer specs." },
];
...
export default function FlyerDesign() {
    ...
    const PLANS = content.servicePackages["flyer-design"];
                ...
                <div className="relative mx-auto max-w-7xl">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <p className="mx-auto mt-6 max-w-[52ch] text-[1.05rem] leading-relaxed text-[#596887] dark:text-[#B9C7E0]">
                            Promote events, launches, and offers with flyers designed to convert — not just look good.
                            Print & digital files, mockups, and printer coordination included.
                        </p>
                        ...
                        <div className="mx-auto mt-14 grid max-w-lg grid-cols-3 gap-6 border-t border-black/8 pt-8 dark:border-white/[0.09]">
                            <div>
                                ...
                                <span className="font-mono text-[0.72rem] text-[#8b95ad] dark:text-[#7C8AAD]">FLYERS PRINTED</span>
                            </div>
                            <div>
                                <b className="block font-sora text-2xl font-bold text-[#1a1f36] dark:text-white">48h</b>
                ...
                <div className="relative mx-auto max-w-7xl">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <h2 className="mt-5 font-sora text-[2rem] font-bold leading-tight text-[#1a1f36] sm:text-[2.5rem] dark:text-white">
                            Designed for response, not just reach.
                        </h2>
                    </div>
            ...
            <section id="process" className="relative px-5 py-20 sm:px-8 md:px-16">
                <div className="mx-auto max-w-7xl">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <h2 className="mt-5 font-sora text-[2rem] font-bold leading-tight text-[#1a1f36] sm:text-[2.5rem] dark:text-white">
                            From brief to bulletin board in four steps.
                        </h2>
                    </div>
                    ...
                    <div className="overflow-hidden rounded-[28px] border border-black/8 bg-gradient-to-br from-white via-[#f1f3f8] to-[#e8ecf4] p-10 sm:p-14 text-center dark:border-white/[0.09] dark:from-[#0F1E3D] dark:via-[#0B1730] dark:to-[#060B14]">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="mx-auto mt-4 max-w-[48ch] text-[1rem] leading-relaxed text-[#596887] dark:text-[#B9C7E0]">
                                Tell us the date, offer, and audience. We'll deliver designs that get people through the door.
                            </p>
