...
const FEATURES = [
    {
        ...
        desc: "Hand-drawn artwork tailored to your brand — no stock vectors or templates.",
    },
    {
        icon: Palette,
        title: "Color Separation Ready",
        desc: "Files pre-separated for screen printing, DTG, embroidery, or sublimation.",
    },
    {
        icon: Layers,
        title: "Multiple Placements",
        desc: "Front, back, sleeves, neck label, hem tags — we design for every printable area.",
    },
    {
        icon: Image,
        title: "Realistic Mockups",
        desc: "See your design on 5+ garment styles before you commit to print.",
    },
    {
        icon: FileText,
        title: "Production Tech Pack",
        desc: "Spec sheets with Pantone codes, placement measurements, and print instructions.",
    },
    {
        icon: CheckCircle2,
        title: "Print Vendor Liaison",
        desc: "We communicate directly with your printer to ensure perfect results.",
    },
];

const PROCESS_STEPS = [
    { num: "01", title: "Brief & Research", desc: "We learn your brand, audience, and garment type to craft a focused brief." },
    { num: "02", title: "Concept Sketches", desc: "3–5 rough directions exploring different visual approaches." },
    { num: "03", title: "Refinement", desc: "Your chosen concept polished with typography, color, and placement precision." },
    { num: "04", title: "Production Files", desc: "Separated AI/PSD, high-res PNGs, mockups, and printer-ready tech pack delivered." },
];
...
export default function TShirtDesign() {
    ...
    const PLANS = content.servicePackages["tshirt-design"];
                ...
                <div className="relative mx-auto max-w-7xl">
                    <div className="mx-auto max-w-3xl text-center">
                        ...
                        <p className="mx-auto mt-6 max-w-[52ch] text-[1.05rem] leading-relaxed text-[#596887] dark:text-[#B9C7E0]">
                            From team uniforms to retail merch — we design tees people actually want to wear.
                            Print-ready files, vendor liaison, and mockups included.
                        </p>
                        ...
                        <div className="mx-auto mt-14 grid max-w-lg grid-cols-3 gap-6 border-t border-black/8 pt-8 dark:border-white/[0.09]">
                            <div>
                                <b className="block font-sora text-2xl font-bold text-[#1a1f36] dark:text-white">500+</b>
                                <span className="font-mono text-[0.72rem] text-[#8b95ad] dark:text-[#7C8AAD]">DESIGNS PRINTED</span>
                            </div>
                            <div>
                                <b className="block font-sora text-2xl font-bold text-[#1a1f36] dark:text-white">50+</b>
                                <span className="font-mono text-[0.72rem] text-[#8b95ad] dark:text-[#7C8AAD]">BRANDS SERVED</span>
                            </div>
                            <div>
                                <b className="block font-sora text-2xl font-bold text-[#1a1f36] dark:text-white">100%</b>
                                <span className="font-mono text-[0.72rem] text-[#8b95ad] dark:text-[#7C8AAD]">PRINT-READY</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative mx-auto max-w-7xl">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <h2 className="mt-5 font-sora text-[2rem] font-bold leading-tight text-[#1a1f36] sm:text-[2.5rem] dark:text-white">
                            Designed for print, not just pixels.
                        </h2>
                    </div>
