...
const FEATURES = [
    {
        icon: Sparkles,
        title: "Narrative Flow Design",
        desc: "We structure content so readers journey from curiosity to conversion naturally.",
    },
    {
        icon: Palette,
        title: "Typography Systems",
        desc: "Hierarchical type scales, optimal line lengths, and readability-first layouts.",
    },
    {
        icon: Layers,
        title: "Modular Grid Systems",
        desc: "Flexible grids that adapt across bi-fold, tri-fold, and multi-page formats.",
    },
    {
        icon: Image,
        title: "Photography Art Direction",
        desc: "Image selection, cropping, and treatment guidance for cohesive visual storytelling.",
    },
    {
        icon: FileText,
        title: "Data-Merge Ready",
        desc: "Multi-page catalogs built for InDesign data-merge — update products in seconds.",
    },
    {
        icon: CheckCircle2,
        title: "Print Production Management",
        desc: "Preflight checks, printer proofs, paper stock recommendations, and press coordination.",
    },
];

const PROCESS_STEPS = [
    { num: "01", title: "Content Audit", desc: "We organize your copy, images, and data into a logical information architecture." },
    { num: "02", title: "Structure & Wireframes", desc: "Page-by-page wireframes showing content hierarchy and visual flow." },
    { num: "03", title: "Design System", desc: "Typography, color, grids, and component styles applied across all pages." },
    { num: "04", title: "Production & Delivery", desc: "Print-ready PDFs, interactive PDFs, source files, and printer coordination." },
];
...
export default function BrochureDesign() {
    ...
    const PLANS = content.servicePackages["brochure-design"];
                ...
                <div className="relative mx-auto max-w-7xl">
                    <div className="mx-auto max-w-3xl text-center">
                        <span className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#45CFFF]/20 bg-[#45CFFF]/10 px-4 py-1.5 font-mono text-[11px] uppercase tracking-[0.18em] text-[#45CFFF]">
                            <BookImage size={14} /> Brochure Design
                        </span>
                        ...
                        <p className="mx-auto mt-6 max-w-[52ch] text-[1.05rem] leading-relaxed text-[#596887] dark:text-[#B9C7E0]">
                            From bi-fold company profiles to multi-page product catalogs — structured layouts,
                            beautiful typography, and print-perfect production files.
                        </p>
                        ...
                        <div className="mx-auto mt-14 grid max-w-lg grid-cols-3 gap-6 border-t border-black/8 pt-8 dark:border-white/[0.09]">
                            <div>
                                <b className="block font-sora text-2xl font-bold text-[#1a1f36] dark:text-white">50+</b>
                                <span className="font-mono text-[0.72rem] text-[#8b95ad] dark:text-[#7C8AAD]">CATALOGS DELIVERED</span>
                            </div>
                            <div>
                                <b className="block font-sora text-2xl font-bold text-[#1a1f36] dark:text-white">100%</b>
                                <span className="font-mono text-[0.72rem] text-[#8b95ad] dark:text-[#7C8AAD]">PRINT-PASSED</span>
                            </div>
                            <div>
                                <b className="block font-sora text-2xl font-bold text-[#1a1f36] dark:text-white">3-Day</b>
                                <span className="font-mono text-[0.72rem] text-[#8b95ad] dark:text-[#7C8AAD]">AVG TURNAROUND</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="relative mx-auto max-w-7xl">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <h2 className="mt-5 font-sora text-[2rem] font-bold leading-tight text-[#1a1f36] sm:text-[2.5rem] dark:text-white">
                            Structured for reading. Designed for results.
                        </h2>
                    </div>
                ...
                <div className="mx-auto max-w-7xl">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <p className="mt-4 text-[1rem] leading-relaxed text-[#596887] dark:text-[#B9C7E0]">
                            Every plan includes print-ready files, mockups, and direct printer communication.
                        </p>
                    </div>
                    ...
                    <div className="mt-14 grid gap-6 md:grid-cols-3">
                        {PLANS.map((plan) => (
                            ...
                            >
                                ...
                                <button
                                    onClick={() => addItem({
                                        id: `brochure-${plan.name}`,
                                        serviceKey: "brochure-design",
                                        name: plan.name,
                                        price: plan.price,
                                        period: plan.period,
            ...
            <section id="process" className="relative px-5 py-20 sm:px-8 md:px-16">
                <div className="mx-auto max-w-7xl">
                    <div className="mx-auto max-w-2xl text-center">
                        ...
                        <h2 className="mt-5 font-sora text-[2rem] font-bold leading-tight text-[#1a1f36] sm:text-[2.5rem] dark:text-white">
                            From content audit to press-ready in four steps.
                        </h2>
                    </div>
                    ...
                    <div className="overflow-hidden rounded-[28px] border border-black/8 bg-gradient-to-br from-white via-[#f1f3f8] to-[#e8ecf4] p-10 sm:p-14 text-center dark:border-white/[0.09] dark:from-[#0F1E3D] dark:via-[#0B1730] dark:to-[#060B14]">
                        ...
                        <div className="relative z-10">
                            <h2 className="font-sora text-[2rem] font-bold leading-tight text-[#1a1f36] sm:text-[2.5rem] dark:text-white">
                                Ready to showcase your offerings?
                            </h2>
                            <p className="mx-auto mt-4 max-w-[48ch] text-[1rem] leading-relaxed text-[#596887] dark:text-[#B9C7E0]">
                                Send us your copy, images, and product data. We'll deliver a brochure that sells.
                            </p>
