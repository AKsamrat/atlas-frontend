...
const pageMeta: Record<string, { title: string; section: string }> = {
    "/user": { title: "My Dashboard", section: "Employee" },
    "/user/profile": { title: "My Profile", section: "Employee" },
    "/user/attendance": { title: "Attendance", section: "Employee" },
    "/user/leave": { title: "Leave Management", section: "Employee" },
    "/user/salary": { title: "Salary History", section: "Employee" },
};
...
const UserLayout = () => {
    ...
    const meta = pageMeta[location.pathname] || { title: "Dashboard", section: "Employee" };
                ...
                <header className="sticky top-0 z-30 bg-white/80 dark:bg-[#0B1730]/80 backdrop-blur-xl border-b border-black/[0.06] dark:border-white/[0.06]">
                    <div className="flex items-center justify-between h-16 px-4 sm:px-6">
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <NotificationBell panel="employee" />
                            ...
                            <div ref={profileRef} className="relative">
                                ...
                                >
                                    ...
                                    <div className="hidden md:block text-left">
                                        ...
                                        <p className="text-[11px] text-[#8b95ad] capitalize leading-tight">Employee</p>
                                    </div>
                                ...
                                {profileOpen && (
                                    <div className="absolute right-0 top-full mt-2 w-56 bg-white dark:bg-[#0F1E3D] rounded-2xl border border-black/[0.06] dark:border-white/[0.08] shadow-2xl overflow-hidden">
                                        ...
                                        <div className="py-1.5">
                                            ...
                                            <button
                                                onClick={() => { navigate("/user/settings"); setProfileOpen(false); }}
                                                className="flex items-center gap-2.5 w-full px-4 py-2.5 text-[13px] text-[#596887] hover:bg-[#f8f9fc] dark:hover:bg-white/[0.04] hover:text-[#1a1f36] dark:hover:text-white transition-colors"
                                            >
                                                <Settings size={15} />
                                                <span>Settings</span>
