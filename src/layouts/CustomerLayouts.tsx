    ...
    return (
        <div className="min-h-screen bg-[#f8f9fc] dark:bg-[#060B14] flex">
            ...
            <div className="flex-1 bg-[#f8f9fc] dark:bg-[#060B14]">
                <header className="bg-white dark:bg-[#0F1E3D] shadow-sm border-b border-black/8 dark:border-white/8">
                    <div className="px-6 py-4">
                        <div className="flex items-center justify-between">
                            <div>
                                <p className="text-xs font-mono uppercase tracking-wider text-[#45CFFF] mb-1">Customer</p>
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    {user?.avatar ? (
                                        ...
                                        <div className="w-9 h-9 bg-gradient-to-br from-[#45CFFF] to-[#1E56E0] rounded-full flex items-center justify-center">
                                            <span className="text-white text-sm font-bold">{userName[0]?.toUpperCase() || "C"}</span>
                                        </div>
                                    )}
                                </div>
                            </div>
